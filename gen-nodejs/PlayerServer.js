...
var PlayerServer_uploadMap_args = function(args) {
  this.gamemap = null;
  if (args) {
...
var PlayerServer_uploadMap_result = function(args) {
};
...
var PlayerServer_uploadParamters_args = function(args) {
  this.arguments = null;
  if (args) {
...
var PlayerServer_uploadParamters_result = function(args) {
};
...
var PlayerServer_assignTanks_args = function(args) {
  this.tanks = null;
  if (args) {
...
var PlayerServer_assignTanks_result = function(args) {
};
...
var PlayerServer_latestState_args = function(args) {
  this.state = null;
  if (args) {
...
var PlayerServer_latestState_result = function(args) {
};
...
var PlayerServer_getNewOrders_args = function(args) {
};
...
var PlayerServer_getNewOrders_result = function(args) {
  this.success = null;
  if (args) {
...
var PlayerServerClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
var PlayerServerProcessor = exports.Processor = function(handler) {
  ...
  if (this._handler.uploadMap.length === 1) {
    Q.fcall(this._handler.uploadMap, args.gamemap)
      .then(function(result) {
        var result_obj = new PlayerServer_uploadMap_result({success: result});
    ...
    this._handler.uploadMap(args.gamemap, function (err, result) {
      ...
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new PlayerServer_uploadMap_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("uploadMap", Thrift.MessageType.REPLY, seqid);
      } else {
...
PlayerServerProcessor.prototype.process_uploadParamters = function(seqid, input, output) {
  ...
  if (this._handler.uploadParamters.length === 1) {
    Q.fcall(this._handler.uploadParamters, args.arguments)
      .then(function(result) {
        var result_obj = new PlayerServer_uploadParamters_result({success: result});
    ...
    this._handler.uploadParamters(args.arguments, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new PlayerServer_uploadParamters_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("uploadParamters", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("uploadParamters", Thrift.MessageType.EXCEPTION, seqid);
...
PlayerServerProcessor.prototype.process_assignTanks = function(seqid, input, output) {
  ...
  if (this._handler.assignTanks.length === 1) {
    Q.fcall(this._handler.assignTanks, args.tanks)
      .then(function(result) {
        var result_obj = new PlayerServer_assignTanks_result({success: result});
    ...
    this._handler.assignTanks(args.tanks, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new PlayerServer_assignTanks_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("assignTanks", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("assignTanks", Thrift.MessageType.EXCEPTION, seqid);
...
PlayerServerProcessor.prototype.process_latestState = function(seqid, input, output) {
  ...
  if (this._handler.latestState.length === 1) {
    Q.fcall(this._handler.latestState, args.state)
      .then(function(result) {
        var result_obj = new PlayerServer_latestState_result({success: result});
    ...
    this._handler.latestState(args.state, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new PlayerServer_latestState_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("latestState", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("latestState", Thrift.MessageType.EXCEPTION, seqid);
...
PlayerServerProcessor.prototype.process_getNewOrders = function(seqid, input, output) {
  ...
  if (this._handler.getNewOrders.length === 0) {
    Q.fcall(this._handler.getNewOrders)
      .then(function(result) {
        var result_obj = new PlayerServer_getNewOrders_result({success: result});
    ...
    this._handler.getNewOrders(function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new PlayerServer_getNewOrders_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("getNewOrders", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("getNewOrders", Thrift.MessageType.EXCEPTION, seqid);
